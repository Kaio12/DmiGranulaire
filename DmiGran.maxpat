...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 729.0, 917.0, 150.0, 33.0 ],
					"text" : "deux directions, le pad, l'ipad...."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1054.0, 835.0, 150.0, 60.0 ],
					"text" : "construction d'une piste avec les numéros de pad et les timings correspondants??"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 875.5, 832.0, 153.0, 47.0 ],
					"text" : "décomposition de l'espace en 64 cases numérotées, comme le launchpad"
				}

			}
, 			{
				"box" : 				{
					"bgcolor" : [ 0.462745098039216, 0.207843137254902, 0.207843137254902, 1.0 ],
					"id" : "obj-51",
					"linecount" : 4,
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 714.0, 832.0, 150.0, 60.0 ],
					"text" : "Avec Distribute, est il utile d'utiliser le knn??\ncela gène pour la latence, est la synchro audio..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 164.545448660850525, 934.545421123504639, 29.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 101.0, 670.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 289.5, 829.0, 65.0, 22.0 ],
					"text" : "gettime $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 288.500003814697266, 800.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 297.0, 856.363605737686157, 207.0, 22.0 ],
					"saved_object_attributes" : 					{
						"verbose" : 1
					}
,
					"text" : "mubu.track echantillons partielsSynth"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 119.0, 772.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 102.500003814697266, 747.0, 506.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 77.0, 339.0, 68.0, 22.0 ],
									"text" : "print partiel"
								}
...
,
					"patching_rect" : [ 100.0, 57.0, 69.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 12.0, 65.0, 150.0, 20.0 ],
									"style" : "default",
									"text" : "scale with the launchpad"
								}
...
, 							{
								"box" : 								{
									"comment" : "bounds X (domain)",
									"id" : "obj-7",
									"index" : 2,
									"maxclass" : "outlet",
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 425.0, 649.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 143.0, 169.0, 116.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 340.0, 70.0, 81.0, 20.0 ],
									"text" : "from imubu"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 12.0, 35.0, 150.0, 20.0 ],
									"style" : "default",
									"text" : "get the imubu bounds"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 793.0, 285.0, 57.0, 22.0 ],
									"text" : "s bounds"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 484.0, 298.0, 57.0, 22.0 ],
									"text" : "s domain"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 781.0, 311.0, 80.0, 22.0 ],
									"text" : "value bounds"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 396.0, 298.0, 80.0, 22.0 ],
									"text" : "value domain"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 189.0, 265.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 94.0, 277.0, 55.0, 22.0 ],
									"text" : "stripnote"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 174.0, 573.0, 61.0, 22.0 ],
									"text" : "pack 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 600.0, 416.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 260.0, 337.0, 29.5, 22.0 ],
									"text" : "8."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 224.0, 340.0, 29.5, 22.0 ],
									"text" : "1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 641.0, 352.0, 29.5, 22.0 ],
									"text" : "8."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 604.0, 355.0, 29.5, 22.0 ],
									"text" : "1."
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 154.0, 340.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 94.0, 340.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 94.0, 308.0, 36.0, 22.0 ],
									"text" : "% 10"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 94.0, 168.0, 41.0, 22.0 ],
									"text" : "notein"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 425.0, 330.0, 66.0, 20.0 ],
									"text" : "bounds X"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 174.0, 387.0, 229.000000000000057, 22.0 ],
									"text" : "scale"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 359.0, 328.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 300.0, 328.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 300.0, 298.0, 74.0, 22.0 ],
									"text" : "unpack 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 300.0, 269.0, 79.0, 22.0 ],
									"text" : "route bounds"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 300.0, 244.0, 79.0, 22.0 ],
									"text" : "route domain"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 808.0, 345.0, 69.0, 20.0 ],
									"text" : "bounds Y"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 749.0, 344.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 694.0, 344.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "float" ],
									"patching_rect" : [ 694.0, 311.0, 74.0, 22.0 ],
									"text" : "unpack 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 694.0, 285.0, 79.0, 22.0 ],
									"text" : "route bounds"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 694.0, 258.0, 81.0, 22.0 ],
									"text" : "route lesdeux"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 694.0, 232.0, 63.0, 22.0 ],
									"text" : "route view"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 600.0, 387.0, 172.56605589389801, 22.0 ],
									"text" : "scale"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 174.0, 649.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 605.0, 713.0, 117.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 906.0, 47.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 908.0, 119.0, 61.0, 22.0 ],
					"text" : "s toimubu"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1053.0, 51.0, 61.0, 22.0 ],
					"text" : "s toimubu"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1053.0, 21.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 908.0, 89.0, 88.0, 22.0 ],
					"text" : "foremost audio"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1001.0, -14.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 958.0, 16.0, 49.0, 22.0 ],
					"text" : "s finEnr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 958.0, -13.0, 34.0, 22.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1033.0, 87.0, 40.0, 97.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "cursor 2064.060174 0.457006"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 980.0, 135.0, 45.0, 45.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 905.0, 162.0, 59.0, 22.0 ],
					"text" : "record $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 908.0, -2.0, 24.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 905.0, 192.0, 182.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"cursor_position" : [ 2064.060174058867688, 0.457006058189286 ],
					"cursor_shape" : "cross",
					"cursor_size" : 4,
					"cursor_sizeunit" : 0,
					...
					"cursor_visible" : 1,
					"dirtypatcher" : 1,
					"domain_bounds" : [ 1798.56571484245319, 3925.345797714368928 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 614.5, 747.1640625, 504.0546875, 747.1640625, 504.0546875, 298.7421875, 223.5, 298.7421875 ],
					"source" : [ "obj-133", 0 ]
				}
